    ...
    <div class="container-fluid">
        ...
        ?>             
                    ...
                    <div class="col-md-4 col-sm-6 portfolio-item" id="<?=$viv_uni['category']?>">
                        ...
                        <div class="portfolio-caption">
                            <h6 class="col-md-8"style="text-align:left;"><?=$viv_uni['title']?></h6>
                            <p class="col-md-4"style="text-align:right;"><?=$viv_uni['superficie']?> m2</p>
                        </div>
                    </div>
        ...
        ?>             
                    ...
                    <div class="col-md-4 col-sm-6 portfolio-item">
                        ...
                        <div class="portfolio-caption">
                            <h6 class="col-md-8"style="text-align:left;"><?=$edificio['title']?></h6>
                            <p class="col-md-4"style="text-align:right;"><?=$edificio['superficie']?> m2</p>
                        </div>
                    </div>
